                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="tanggal-transaksi" data-target-input="nearest">
                                <input type="text" class="form-control datetimepicker-input" name="tanggal_transaksi" value="{{ $nasabah->tanggal_transaksi }}" data-target="#tanggal-transaksi" placeholder="Tanggal Transaksi" required/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama-nasabah" value="{{ $nasabah->nama_nasabah }}" name="nama_nasabah" placeholder="Nama Nasabah" required>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="custom-select" id="jenis-sampah" name="jenis_sampah_id" required>
                                ...
                                @foreach ($jenisSampah as $item)
                                    <option value="{{ $item->id }}" {{ $item->id == $nasabah->jenis_sampah_id ? 'selected' : '' }}>{{ $item->jenis_sampah }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="berat-sampah">Berat</label>
                            <input type="number" class="form-control" id="berat-sampah" value="{{ $nasabah->berat_sampah }}" name="berat_sampah" placeholder="Berat Sampah" required>
